...
export const DataProvider = ({ children }) => {
  ...
  const [salesChartData, setSalesChartData] = useState([
    { name: 'تشرين الثاني', إجمالي_المبيعات: 4000, عدد_المنتجات: 2400 },
    { name: 'شباط', إجمالي_المبيعات: 3000, عدد_المنتجات: 1398 },
    { name: 'آذار', إجمالي_المبيعات: 2000, عدد_المنتجات: 9800 },
    { name: 'نيسان', إجمالي_المبيعات: 2780, عدد_المنتجات: 3908 },
    { name: 'ايلول', إجمالي_المبيعات: 1890, عدد_المنتجات: 4800 },
    { name: 'حزيران', إجمالي_المبيعات: 2390, عدد_المنتجات: 3800 },
    { name: 'آب', إجمالي_المبيعات: 3490, عدد_المنتجات: 4300 },
  ]);
